...
class premabletestRTL(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_1_0.set_y_axis(-BW/samp_rate, BW/samp_rate)
        ...
        self.qtgui_time_sink_x_0_1.set_y_axis(-BW/samp_rate, BW/samp_rate)

        self.qtgui_time_sink_x_0_1.set_y_label('Frequency', "")
        ...
        self.connect((self.LibreLoRa_correlationSync_0, 1), (self.LibreLoRa_symbolDemod_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_time_sink_x_0_1.set_y_axis(-self.BW/self.samp_rate, self.BW/self.samp_rate)
        self.qtgui_time_sink_x_0_1.set_samp_rate(self.samp_rate)
        self.qtgui_time_sink_x_0_1_0.set_y_axis(-self.BW/self.samp_rate, self.BW/self.samp_rate)
